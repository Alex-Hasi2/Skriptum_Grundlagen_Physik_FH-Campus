...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \node[anchor=south west, inner sep=0] (myImage) at (0,0) {
            \includegraphics[width=0.5\linewidth]{Bilder/Kapitel_Rotation/schwerpunkt_rs_ris_ri_Kugel.png}
        };
        ...
        \begin{scope}[x={(myImage.south east)}, y={(myImage.north west)}]
            ...
            \node at (0.7, 0.94) {\large $\protect\ivec{\omega}$};  % Near top right
            \node at (0.60, 1.0) {\large $\protect\ivec{A}$};  % Near top right
    ...
    \end{tikzpicture}
    \caption{.}\label{fig: aufteilung_bewegung_schwerpunkt}
\end{figure}
