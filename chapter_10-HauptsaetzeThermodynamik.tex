...
\begin{figure}[htb]
    ...
    \caption{Darstellung der vier speziellen Zustandsänderungen in einem $(p,T)$-Diagramm (links) und einem $(p,V)$-Diagramm (rechts). Die Zustände in den Punkten $O_{1,2}$ lauten: $O_1 = (p=\SI{1}{\bar}, V=\SI{24.9}{\deci\meter^3}, T=\SI{300}{\kelvin})$ und $O_2 = (p=\SI{0.5}{\bar}, V=\SI{116.4}{\deci\meter^3}, T=\SI{700}{\kelvin})$. Beachten Sie, dass Adiabaten im $(p,V)$-Diagramm steiler verlaufen als Isothermen.}\label{fig: pv_diagramm_prozesse}
\end{figure}
