...
\begin{figure}
    ...
    \caption{Die Geschwindigkeit $\protect\ivec{v}(t)$ steht immer tangential auf die Bahnkurve. Die Beschleunigung hat jedoch zwei Anteile, die normal aufeinander stehen: die Tangentialbeschleunigung $\protect\ivec{a}_t$ und die Normalbeschleunigung $\protect\ivec{a}_n$.}\label{fig: allg_krummlinige_bewegung}
\end{figure}
