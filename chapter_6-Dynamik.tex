...
\begin{figure}[htbp]
    ...
    \caption{Eine Masse, die an einer Feder befestigt ist. a) In der Ruhelage $x=x_0=0$. b) Auslenkung in die positive $x$-Richtung, $\Delta x > 0$. c) Kompression in die negative $x$-Richtung, $\Delta x < 0$.}\label{fig: feder_rückstellkraft}
\end{figure}
