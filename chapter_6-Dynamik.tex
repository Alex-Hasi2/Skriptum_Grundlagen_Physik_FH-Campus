...
\begin{figure}[htb]
    ...
    \caption{Die Zentrifugalbeschleunigung $\protect\ivec{a}_{\text{Zf}}$ und die Coriolisbeschleunigung $\protect\ivec{a}_{\text{C}}$ für einen Punkt $A$, der sich mit der Geschwindigkeit $\protect\ivec{v}'$ in einem rotierenden Bezugssystem bewegt.}\label{fig: coriolis_zentrifugalbeschl}
\end{figure}
