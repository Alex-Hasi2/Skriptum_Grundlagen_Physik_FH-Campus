...
\usepackage{amsmath}      % Für mathematische Befehle wie \vec
...
\begin{tikzpicture}[>=Latex]
    ...
    \begin{scope}[xshift=\offset cm]
        ...
        % Mitte (Fläche A)
        \node[blue!90!black, font=\bfseries] at (\cylW/2, \hBase - \AOffset) {\Large $Ab$};
    \end{scope}
\end{tikzpicture}
...
%     \node[point, label={[label_box]left:$\ivec{P}_1$}] at (P1) {};
%     \node[point, label={[label_box]right:$\ivec{P}_2$}] at (P2) {};
