...
\begin{figure}[htb]
    ...
    \caption{Ein Objekt wird von der Oberfläche eines Himmelskörpers (Masse $M$, Radius $R$) mit der Anfangsgeschwindigkeit $\protect\ivec{v}_0$ senkrecht nach oben abgefeuert.}\label{fig: zweite_kosmische_geschwindigkeit}
\end{figure}
