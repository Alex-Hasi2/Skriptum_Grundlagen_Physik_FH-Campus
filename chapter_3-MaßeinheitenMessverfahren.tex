...
Es ist wichtig, die Masse als eine intrinsische Eigenschaft von Materie vom Gewicht zu unterscheiden, welches die Kraft darstellt, die durch die Gravitation auf eine Masse wirkt $F_G = m\cdot g$. Die Neudefinition von 2018 war notwendig, da das physische Urkilogramm über die Zeit an Masse verlor und somit keine stabile Referenz mehr darstellte.
...
\textbf{Lösung:}
Wie oben erwähnt, kann es nur eine Multiplikation oder Division der Größen mit unterschiedlichen Potenzen sein. Negative Hochzahlen drücken dabei Brüche aus. Joule ersetzen wir laut Tabelle durch die Basiseinheiten $\si{\kilo\gram\meter^2/\second^2}$. Wir setzen daher variable Hochzahlen an. \textit{Merke:} Es werden nur die Einheiten gleichgesetzt nicht die physikalischen Größen!
