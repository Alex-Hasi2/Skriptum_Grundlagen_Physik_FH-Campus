...
\begin{enumerate}[label=\textbf{\arabic*.},itemsep=0.50cm]
    ...
    \begin{solutionbox}
        ...
        \]
        Da die Geschwindigkeit konstant ist, gilt für die Beschleunigung \(a = \SI{0}{\meter\per\second\squared}\).
    \end{solutionbox}
    ...
    \begin{solutionbox}
        \[
        \overline{v} = \frac{\Delta s}{\Delta t} = \frac{\SI{100}{\meter}}{\SI{12}{\second}} = \SI{8.33}{\meter\per\second}
        \]
    \end{solutionbox}
