...
\section*{\LARGE Lösung: Kurztest 1}
\noindent
\begin{tabular}{ll}
...
\begin{enumerate}[label=\textbf{\arabic*.},itemsep=0.50cm]
    ...
    Sie möchten die Periodenlänge $T$ eines Pendels mit einer Stoppuhr messen und übersehen, dass der Knoten des Fadens im Aufhängepunkt zu einer nicht vernachlässigbaren Reibung führt, die die Bewegung bremst. 
    Was passiert mit Ihren Messwerten $T_i$ im Vergleich zum Wert $T_W$? Um welche Art von Fehler handelt es sich dabei? 
    \begin{solutionbox}
        Die Reibung bremst die Bewegung (Dämpfung), wodurch die gemessene Periodendauer tendenziell länger ist als die des idealen, reibungsfreien Pendels. Die Messwerte $T_i$ werden also systematisch größer sein als der wahre Wert $T_W$.
