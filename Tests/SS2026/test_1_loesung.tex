...
\begin{enumerate}
    ...
    \item \textbf{\SI{2.0012}{\metre}} \quad denn zunächst gilt
    \[
        L = L_0(1 + \alpha \Delta T)
    \]
    und erst am Ende numerisch
    \[
        L = \SI{2}{\metre}\left(1 + \SI{12e-6}{\per\kelvin} \cdot \SI{50}{\kelvin}\right) = \SI{2.0012}{\metre}
    \]
\end{enumerate}
