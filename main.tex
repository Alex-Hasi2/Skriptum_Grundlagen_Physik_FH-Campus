...
\begin{itemize}
    ...
    \item \textbf{Isentroper Prozess ($S = \const$):} Die Entropie bleibt konstant. Für reversible Prozesse ist dies äquivalent zu einem adiabatischen Prozess. Es gilt ebenfalls $dQ=0$ und somit $dU = dW = -p \cdot dV$.
\end{itemize}
