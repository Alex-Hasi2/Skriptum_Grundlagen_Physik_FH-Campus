...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Phasendiagramm von Wasser: Die Schmelzkurve (fest/flüssig) verläuft nach links oben.}\label{fig: phasendiagramm_wasser}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
...
Eine Besonderheit von $\text{CO}_2$ ist die Lage des Tripelpunkts bei $p_{\text{Tr}} \approx \SI{5.1}{\bar}$. Da unser Atmosphärendruck ($\approx \SI{1}{\bar}$) unterhalb dieses Drucks liegt, gibt es bei Normalbedingungen kein flüssiges $\text{CO}_2$. Festes $\text{CO}_2$ (Trockeneis) geht beim Erwärmen direkt in den gasförmigen Zustand über (Sublimation).
