...
Um eine Messung durchzuführen, wird der bewegliche Behälter $B_3$ vertikal so verschoben, dass der Quecksilberspiegel im Schenkel $B_2$ exakt auf der Referenzmarke (bei 0) steht. Damit nimmt das Gas in $B_1$ immer dasselbe Volumen ein.\\
